...
class BillPage extends StatefulWidget {
  static const routerName = '/bill-page';
      ...
      body: Stack(children: [
        Container(
          ...
          child: SingleChildScrollView(
            // bị dư quá nhiều khoảng trắng ở dưới khi trượt lên
                          ...
                          if (_formKey.currentState!.validate()) {
                            setState(() {
                              bill = BillModel(
                                  ...
                                  total:
                                      double.parse(thanhTienViController.text),
                                  isCheckVip: isValue);
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Padding(
                          ...
                          child:
                              CustomContainer(billModel: listBillData[index]),
                        );
                      },
                    ),
                  ),
